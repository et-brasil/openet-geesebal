...
def radiation_inst(landsat_image,time_start,dem,lst,emissivity,albedo,tair,rh,swdown_inst,sun_elevation):
...
def et_fraction(landsat_image,et,et_reference_source,et_reference_band,et_reference_factor):
    
    _date=ee.Date(landsat_image.get('system:time_start'))
